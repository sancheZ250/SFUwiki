    ...
    <router-link :to="'/institutes/' + teacher.institute + '/teachers/' + teacher.id">
      <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl m-4">
        <div class="md:flex">
          ...
          <div class="p-8">
            <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">{{ teacher.name }}</a>
            <div class="mt-4">
                ...
                <div class="flex items-center">
                  <div class="text-sm">
                    <div class="flex items-center mt-1">
                      ...
                      <span class="ml-2">{{ teacher.avg_rating }}</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="flex mt-4 items-center">
                <div class="text-sm">
                  <div class="flex items-center mt-1">
                    ...
                    <span class="ml-2">{{ teacher.review_count }}</span>
                  </div>
                </div>
              </div>
            </div>
